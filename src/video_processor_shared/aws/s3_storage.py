...
class S3StorageService:
    ...
    def __init__(
        ...
        self.input_bucket: str = input_bucket or os.getenv("S3_INPUT_BUCKET") or "video-uploads"
        self.output_bucket: str = output_bucket or os.getenv("S3_OUTPUT_BUCKET") or "video-outputs"
